...
const education = {
    ...
    title: 'My Education',
    description:
        ' sed nemo labore consequatur at atque est eveniet iusto vel modi ipsum, optio maxime. Repellendus, alias!',
    items: [
        {
            institution: 'University of USA',
    ...
    return (
        ...
        >
            <div className="container mx-auto">
                ...
                >
                    <TabsList className="flex h-6 flex-col w-full max-w-[380px] mx-auto xl:mx-0 gap-6">
                    ...
                    <div className="min-h-[70vh] w-full">
                        ...
                        <TabsContent value="skills" className="w-full h-full">
                            <div className="flex flex-col gap-[30px]">
                                ...
                                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-col-4 xl:gap-[30px]">
